...
public class DriverFactory {
	 ...
	 * </p>
	 * @param pass browser number ex: DriverFactory.Firefox
	 * @return Returns WebDriver object
	 */
	public  WebDriver getDriver(int browser)
	{
		...
		switch (browser){
			case BrowserFlavour.Firefox:
								driver= new FirefoxDriver(BrowserFlavour.getCapabilities(BrowserFlavour.Firefox)); 
								break;
			case BrowserFlavour.InternetExplorer:
								driver = new InternetExplorerDriver(BrowserFlavour.getCapabilities(BrowserFlavour.InternetExplorer));
								break;
			case BrowserFlavour.Chrome:
								driver = new ChromeDriver(BrowserFlavour.getCapabilities(BrowserFlavour.Chrome));
								break;
		}
		return driver;
